...
@section('content')
    ...
    @if(count($candidats) > 0)
        ...
        <div class="mt-3 d-flex justify-content-end">{{ $candidats->links() }}</div>
    @else
        <h3 class="text-danger my-5">Pas de candidat !</h3>
    @endif

   <!-- Modal -->
   <div class="modal fade" id="modifcandidat" tabindex="-1" aria-labelledby="modificationRef" aria-hidden="true">
